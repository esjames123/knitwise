      ...
      {open && (
        ...
        >
          <button
            ...
            style={{ color: '#f5f0eb' }}
          >
            <svg width="12" height="12" viewBox="0 0 24 24" fill={status === 'added' || status === 'already' ? '#D4A5A0' : 'none'}
                 stroke="#D4A5A0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
